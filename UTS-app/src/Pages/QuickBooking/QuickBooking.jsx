  ...
  import { FaUser, FaCalendarAlt, FaIdCard, FaPhone, FaMapMarkerAlt, FaCreditCard, FaMoneyBill, FaTrain } from 'react-icons/fa';
      ...
      if (paymentMethod === 'card') {
        return (
          <div className="border-2 p-4 mt-4 rounded-lg">
            <h3 className="text-lg font-bold mb-2">Unreserved Ticket Receipt</h3>
            <p>Date: {currentDate}</p>
            <p>From: {selectedTicket.from}</p>
            <p>To: {selectedTicket.to}</p>
    ...
    return (
      <div className="min-h-screen bg-orange-50 p-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold text-orange-800 mb-8">Quick Unreserved Ticket Booking</h1>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {unreservedTicketData.routes.map((route) => (
                <div key={route.id} className="bg-orange-50 p-4 rounded-md">
                  <h3 className="font-medium text-lg mb-2">
                    {route.from} → {route.to}
                  </h3>
                  <p className="text-orange-600 font-bold mb-2">₹{route.price}</p>
                  <p className="text-sm text-gray-600 mb-4">Valid for {route.validityHours} hours</p>
                  <button
          ...
          <div className="mt-8 bg-white rounded-lg shadow-lg p-6">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Unreserved tickets are valid only for the selected route.</li>
              <li>Each ticket is valid for {unreservedTicketData.routes[0].validityHours} hours from the time of purchase.</li>
              ...
              <li>Keep the receipt safe until your journey is complete.</li>
              <li>Tickets are non-refundable and non-transferable.</li>
              <li>Follow all station and train safety guidelines.</li>
            </ul>
          </div>
        </div>
        ...
        {showBookingModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-lg p-6 max-w-md w-full">
              <h2 className="text-xl font-semibold mb-4">Confirm Unreserved Ticket</h2>
              <p className="mb-4">Are you sure you want to book a ticket from {selectedTicket.from} to {selectedTicket.to}?</p>
            ...
            <div className="bg-white rounded-lg p-6 max-w-md w-full">
              ...
              {isLoading ? (
                ...
                <div className="text-center text-green-600 py-4">
                  <p className="font-semibold">Unreserved Ticket Booked Successfully!</p>
